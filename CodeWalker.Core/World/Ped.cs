...
namespace CodeWalker.World
{
    [TypeConverter(typeof(ExpandableObjectConverter))] public class Ped
    {
        ...
        public MetaHash NameHash { get; set; } = 0;
        public CPedModelInfo__InitData InitData { get; set; } = null;
        public YddFile Ydd { get; set; } = null;
        public YtdFile Ytd { get; set; } = null;
        public YldFile Yld { get; set; } = null;
        public YcdFile Ycd { get; set; } = null;
        public YedFile Yed { get; set; } = null;
        public YftFile Yft { get; set; } = null;
        public PedFile Ymt { get; set; } = null;
        ...
        public YmapEntityDef RenderEntity = new YmapEntityDef();
        ...
        public void SetComponentDrawable(int index, string name, string tex, GameFileCache gfc)
        {
            ...
            if ((t == null) && (TextureFilesDict != null))
            {
                ...
                if (TextureFilesDict.TryGetValue(texhash, out file))
                {
                    ...
                    {
                        t = ytd.TextureDict.Textures.data_items[0];
                    }
                }
            }
            ...
            if ((cc == null) && (ClothFilesDict != null))
            {
                ...
                if (ClothFilesDict.TryGetValue(namehash, out file))
                {
                    ...
                    {
                        cc = yld.ClothDictionary.Clothes.data_items[0];
                    }
                }
            }
