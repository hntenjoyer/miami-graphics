...
namespace CodeWalker.GameFiles
{
    ...
    [TC(typeof(EXP))] public class CPedModelInfo__InitData
    {
        ...
        public string SuperlodType { get; set; }
        public string ScenarioPopStreamingSlot { get; set; }
        ...
        public CPedModelInfo__InitData(XmlNode node)
        {
            ...
            Radio1 = Xml.GetChildInnerText(node, "Radio1");
            Radio2 = Xml.GetChildInnerText(node, "Radio2");
            ...
            Sexiness = Xml.GetChildInnerText(node, "Sexiness");
            ...
            ExternallyDrivenDOFs = Xml.GetChildInnerText(node, "ExternallyDrivenDOFs");
            PedVoiceGroup = Xml.GetChildInnerText(node, "PedVoiceGroup");
            AnimalAudioObject = Xml.GetChildInnerText(node, "AnimalAudioObject");
            AbilityType = Xml.GetChildInnerText(node, "AbilityType");
            ThermalBehaviour = Xml.GetChildInnerText(node, "ThermalBehaviour");
            SuperlodType = Xml.GetChildInnerText(node, "SuperlodType");
            ScenarioPopStreamingSlot = Xml.GetChildInnerText(node, "ScenarioPopStreamingSlot");
            DefaultSpawningPreference = Xml.GetChildInnerText(node, "DefaultSpawningPreference");
