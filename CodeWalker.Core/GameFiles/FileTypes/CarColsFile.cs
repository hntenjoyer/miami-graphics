...
namespace CodeWalker.GameFiles
{
    ...
    [TC(typeof(EXP))] public class CVehicleModelInfoVarGlobal_465922034
    {
    ...
    [TC(typeof(EXP))] public class CVehicleModelInfoVarGlobal_3027500557
    {
    ...
    [TC(typeof(EXP))] public class CVehicleModelInfoVarGlobal_3062246906
    {
    ...
    public enum CVehicleModelColor_360458334
    {
        none = -1,
    ...
    public enum CVehicleModelColor_544262540
    {
    ...
    public enum CVehicleModelColor_2065815796
    {
        none = 0,
    ...
    public enum CVehicleMod_3635907608
    {
        none = -1,
        chassis = 0,
        bodyshell = 48,
    ...
    public enum eVehicleModCameraPos
    {
        VMCP_DEFAULT = 0,
        VMCP_FRONT = 1,
        VMCP_FRONT_LEFT = 2,
