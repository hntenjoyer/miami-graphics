...
namespace CodeWalker.GameFiles
{
    [TC(typeof(EXP))] public class DistantLightsFile : GameFile, PackedFile
    {
        ...
        public uint[] PathIndices { get; set; }
        public uint[] PathCounts1 { get; set; }
        public uint[] PathCounts2 { get; set; }
        public DistantLightsNode[] Nodes { get; set; }
        public DistantLightsPath[] Paths { get; set; }
        public DistantLightsCell[] Cells { get; set; }
