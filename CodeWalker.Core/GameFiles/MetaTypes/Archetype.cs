...
namespace CodeWalker.GameFiles
{
    ...
    public class Archetype
    {
        ...
        public CBaseArchetypeDef BaseArchetypeDef => _BaseArchetypeDef;
    ...
    public class TimeArchetype : Archetype
    {
        ...
        public CTimeArchetypeDef TimeArchetypeDef => _TimeArchetypeDef;
    ...
    public class MloArchetype : Archetype
    {
        ...
        public CMloArchetypeDef MloArchetypeDef => _MloArchetypeDef;
            ...
            foreach (var portal in portals)
            {
                ...
                foreach(var objIndex in portal.AttachedObjects)
                {
                    ...
                    if (objIndex > deletedIndex)
                        newAttachedObjects.Add(objIndex - 1);
                    else newAttachedObjects.Add(objIndex);
                }
    ...
    public class MloInstanceData
    {
                        ...
                        for (int k = 0; k < room.AttachedObjects.Length; k++)
                        {
                            ...
                            if (objid < Entities.Length)
                            {
                                ...
                                if ((rooment != null) && (rooment.Archetype != null))
                                {
                                    ...
                                    Vector3 abmin = earch.BBMin * rooment.Scale;
        ...
        public void SetPosition(Vector3 pos)
        {
            ...
            cent.position = pos;
            _Instance.CEntityDef = cent;
        }

        public void SetOrientation(Quaternion ori)
        {
            var cent = _Instance.CEntityDef;
            cent.rotation = new Vector4(ori.X, ori.Y, ori.Z, ori.W);
            _Instance.CEntityDef = cent;
        }
