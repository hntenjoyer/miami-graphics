...
namespace CodeWalker.GameFiles
{
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class ShaderGroup : ResourceSystemBlock
    {
        ...
        public uint ShaderGroupBlocksSize { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class ShaderFX : ResourceSystemBlock, IMetaXmlItem
    {
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            if (reader.IsGen9)
            {
                ...
                G9_UnknownParamsPointer = reader.ReadUInt64();
                G9_ParamInfosPointer = reader.ReadUInt64();
                G9_Unknown_28h = reader.ReadUInt64();
                G9_Unknown_30h = reader.ReadUInt64();
                ...
                FileName = JenkHash.GenHash(Name.ToCleanString() + ".sps");
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class ShaderParametersBlock : ResourceSystemBlock
    {
        ...
        public ShaderParamInfosG9 G9_ParamInfos { get; set; }
        public ulong[] G9_BufferPtrs { get; set; }
        public uint[] G9_BufferSizes { get; set; }
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            ...
            if (reader.IsGen9)
            {
                ...
                G9_BufferPtrs = reader.ReadStructs<ulong>(bcnt * mult);
                G9_BufferSizes = new uint[bcnt];
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class ShaderParamInfosG9 : ResourceSystemBlock
    {
        ...
        public byte Unknown2 { get; set; } = 0xc;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class Skeleton : ResourceSystemBlock
    {
        ...
        public ushort Unknown_5Ch { get; set; } = 1;
        ...
        public short[] ChildIndices { get; set; }

        private ResourceSystemStructBlock<Matrix> TransformationsInvertedBlock = null;
        ...
        public Dictionary<ushort, Bone> BonesMap { get; set; }
        public Bone[] BonesSorted { get; set; }
        ...
        public void BuildBonesMap()
        {
            ...
            if (Bones?.Items != null)
            {
                ...
                for (int i = 0; i < Bones.Items.Length; i++)
                {
                    ...
                    bone.TransformUnk = (i < (Transformations?.Length ?? 0)) ? Transformations[i].Column4 : Vector4.Zero;
                }
        ...
        public void BuildTransformations()
        {
            ...
            if (Bones?.Items != null)
            {
                foreach (var bone in Bones.Items)
                {
                    ...
                    var sca = bone.Scale;
                    var m = Matrix.AffineTransformation(1.0f, ori, pos);
                    m.ScaleVector *= sca;
                    m.Column4 = bone.TransformUnk;

                    var pbone = bone.Parent;
                    while (pbone != null)
                    {
                        pos = pbone.Rotation.Multiply(pos ) + pbone.Translation;
                        ori = pbone.Rotation * ori;
                        pbone = pbone.Parent;
                    }
                    var m2 = Matrix.AffineTransformation(1.0f, ori, pos);
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class SkeletonBoneTag : ResourceSystemBlock
    {
        ...
        public SkeletonBoneTag Next { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class Bone : ResourceSystemBlock, IMetaXmlItem
    {
        ...
        public float Unknown_2Ch { get; set; } = 1.0f;
        ...
        public Vector4 TransformUnk { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class Joints : ResourceSystemBlock
    {
        ...
        public ushort Unknown_36h = 1;
        public ulong Unknown_38h;

        public JointRotationLimit_s[] RotationLimits { get; set; }
        public JointTranslationLimit_s[] TranslationLimits { get; set; }

        private ResourceSystemStructBlock<JointRotationLimit_s> RotationLimitsBlock = null;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public struct JointRotationLimit_s : IMetaXmlItem
    {
        ...
        public float Unknown_8Ch { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class DrawableModelsBlock : ResourceSystemBlock
    {
        ...
        public DrawableModel[] Extra { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class DrawableModel : ResourceSystemBlock, IMetaXmlItem
    {
        public override long BlockLength
        {
            ...
            {
                var off = (long)48;
                off += (GeometriesCount1 * 2);
                if (GeometriesCount1 == 1) off += 6;
                else off += ((16 - (off % 16)) % 16);
                off += (GeometriesCount1 * 8);
                off += ((16 - (off % 16)) % 16);
                off += (GeometriesCount1 + ((GeometriesCount1 > 1) ? 1 : 0)) * 32;
        ...
        public uint SkeletonBinding { get; set; }
        public ushort RenderMaskFlags { get; set; }
        public ushort GeometriesCount3 { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class DrawableGeometry : ResourceSystemBlock, IMetaXmlItem
    {
        ...
        public AABB_s AABB { get; set; }

        public bool UpdateRenderableParameters = false;
        ...
        public override void Write(ResourceDataWriter writer, params object[] parameters)
        {
            ...
            this.VertexStride = (ushort)(this.VertexBuffer != null ? this.VertexBuffer.VertexStride : 0);
            this.IndicesCount = (this.IndexBuffer != null ? this.IndexBuffer.IndicesCount : 0);
            this.TrianglesCount = this.IndicesCount / 3;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class VertexBuffer : ResourceSystemBlock
    {
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            ...
            if (reader.IsGen9)
            {
                ...
                G9_Unknown_20h = reader.ReadUInt64();
        ...
        public void InitVertexDataFromGen9Data(byte[] gen9bytes)
        {
            ...
            for (int i = 0; i < g9types.Length; i++)
            {
                var t = g9types[i];
                if (t == 0) continue;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class VertexData : ResourceSystemBlock
    {
        ...
        public byte[] G9_VertexBytes { get; set; }
        ...
        public override void Read(ResourceDataReader reader, params object[] parameters)
        {
            ...
            switch (Info.Types)
            {
                case VertexDeclarationTypes.GTAV1:
                    break;
                case VertexDeclarationTypes.GTAV2:
                    switch (Info.Flags)
                    {
                        case 16473: VertexType = VertexType.PCCH2H4; break;
                        default:break;
                    }
                    break;
                case VertexDeclarationTypes.GTAV3:
                    switch (Info.Flags)
                    {
                        case 89: VertexType = VertexType.PNCH2; break;
                        default: break;
                    }
                    break;
                default:
    ...
    {
        public override long BlockLength => 320;
        ...
        public static VertexComponentType GetLegacyComponentType(VertexDeclarationG9ElementFormat f)
        {
            switch (f)
            {
                ...
                case VertexDeclarationG9ElementFormat.R8G8B8A8_UINT: return VertexComponentType.Colour;
        ...
        public static VertexDeclarationG9ElementFormat GetGen9ComponentType(int lci, VertexDeclarationTypes vdtypes)
        {
            ...
            switch (t)
            {
                ...
                case VertexComponentType.RGBA8SNorm: return VertexDeclarationG9ElementFormat.R8G8B8A8_UNORM;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class IndexBuffer : ResourceSystemBlock
    {
        ...
        public ushort G9_IndexSize { get; set; } = 2;
        public ushort G9_Unknown_Eh;
        public uint G9_BindFlags { get; set; }
        public uint G9_Unknown_14h;
        public ulong G9_SRVPointer { get; set; }
        ...
        private ResourceSystemStructBlock<ushort> IndicesBlock = null;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class LightAttributes : ResourceSystemBlock, IMetaXmlItem
    {
        ...
        public bool UpdateRenderable = false;
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class DrawableBase : ResourceFileBase
    {
        ...
        public ushort DrawableModelsBlocksSize { get; set; }
    ...
    [TypeConverter(typeof(ExpandableObjectConverter))] public class DrawablePtfxDictionary : ResourceFileBase
    {
        ...
        private ResourceSystemStructBlock<uint> HashesBlock = null;
